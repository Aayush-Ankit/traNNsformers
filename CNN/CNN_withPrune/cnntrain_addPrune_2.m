function net = cnntrain_addPrune_2(net, x, y, opts, val_x, val_y)
...
if ((net.prunemode == 1) || (net.prunemode == 2))
    ...
    [er, ~] = cnntest_addPrune(net, val_x, val_y);
    fprintf(fid, ['Epoch 10k sample test accuracy: ' num2str((1-er)*100) '\n']);
    fprintf(['Epoch 10k sample test accuracy: ' num2str((1-er)*100) '\n']);
