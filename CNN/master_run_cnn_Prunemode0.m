...
fid = fopen([sprintf('CNNoutputs/softwarePerspective_AccuracyVsTrainingEffortAnalysis/%s/trace_TEST_prunemode%d_numlayers%d_with%dFClayers_numfilters%dand%d_learningRate%2.2f_xbarutilmin%0.2f',...
...
cnn = cnntrain_addPrune_0(cnn, train_x, train_y, opts, test_x, test_y);
