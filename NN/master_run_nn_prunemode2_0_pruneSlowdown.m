...
fid = fopen(sprintf('output/resultset3_sensitivytToParamVariation/%s/trace_prunemode%d_0_pruneSlowdown_numlayers%d_xbarutilmin%0.2f.txt', data_name, prunemode, nn.n-1, nn.cluster_base_quality_min), 'w');
...
if (nn.prunemode == 2)
    ...
    saveas(fig, sprintf('output/resultset3_sensitivytToParamVariation/%s/hist_prunemode%d_0_pruneSlowdown_numlayers%d_xbarutilmin%0.2f.png', data_name, prunemode, nn.n-1, nn.cluster_base_quality_min))
end
save (sprintf('output/resultset3_sensitivytToParamVariation/%s/nn_prunemode%d_0_pruneSlowdown_numlayers%d_xbarutilmin%0.2f.mat', data_name, prunemode, nn.n-1, nn.cluster_base_quality_min), 'nn', 'opts', 'accuracyVStrainingEffort');
