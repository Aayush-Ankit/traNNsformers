...
save (sprintf('output/%s/nn_prunemode%d_numlayers%d_xbarutilmin%0.2f.mat', data_name, prunemode, nn.n-1, nn.cluster_base_quality_min), 'nn', 'opts', 'accuracyVStrainingEffort');
